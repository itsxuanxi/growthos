...
export function AuthForm({ mode }: { mode: Mode }) {
  ...
  const subtitles: Record<Mode, string> = {
    login: "Log in to your GrowthOS dashboard.",
    signup: "Start finding customers with AI — free.",
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          {mode !== "forgot" && (
            <>
              <button onClick={handleGoogle} className="btn-secondary mt-6 w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === "signup" && (
              <div>
                ...
                <input className="input" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Jane Founder" required />
              </div>
            )}
            <div>
